...
public class HibernateObjectModel<T> extends LoadableWritableModel<T> implements BindingModel<T> {
	 ...
	 */
	public HibernateObjectModel(final Class objectClass, final Serializable entityId) {
	 ...
	 * @param objectClass class to be loaded and stored by Hibernate
	 */
	public HibernateObjectModel(final Class objectClass) {
		this.objectClass = objectClass;
	}
	 ...
	 */
	public HibernateObjectModel(final T persistentObject) {
	 ...
	 */
	public HibernateObjectModel(final String queryString, final QueryBinder queryBinder) {
	 ...
	 */
	public HibernateObjectModel(final Class objectClass, final CriteriaBuilder criteriaBuilder) {
		this.objectClass = objectClass;
	 ...
	 */
	public HibernateObjectModel(final QueryBuilder queryBuilder) {
	 ...
	 */
	public HibernateObjectModel setFactoryKey(final Object key) {
		this.jpaContext = key.toString();
		return this;
	}
	...
	public void setObject(final T object) {
		...
		if (object != null) {
			...
			final Session sess = Databinder.getHibernateSession(jpaContext);
	...
	public Serializable getIdentifier() {
		return Databinder.getHibernateSession(jpaContext).getIdentifier(getObject());
	}
	...
	protected T load() {
      ...
      return null;	// can't load without one of these
		...
		final HibernateEntityManager em = Databinder.getEntityManager(jpaContext);
		if (objectId != null) {
			return (T) em.find(objectClass, objectId);
		}

		if(criteriaBuilder != null) {
			final Criteria criteria = em.getSession().createCriteria(objectClass);
